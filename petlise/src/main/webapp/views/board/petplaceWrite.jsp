  ...
  <div id="container">
    ...
    <div class="categoryWrap">
      ...
      <div class="adressWrap">
        ...
        <input type="text" id="sample6_postcode" placeholder="우편번호" style="padding-left: 16px; margin-left: -45px; pointer-events: none;" />
      ...
      <div class="addressLine">
        <input type="text" id="sample6_address" name="p_address" value="${petplace.p_address}" style="padding-left: 16px; pointer-events: none;" placeholder="주소" />
        <input type="text" id="sample6_detailAddress" name="p_detailaddress" value="${petplace.p_detailaddress}"placeholder="상세주소" style="padding-left: 16px;" />
      </div>
      <div id="map"></div>
