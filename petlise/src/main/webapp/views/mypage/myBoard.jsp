...
<link rel="stylesheet" href="/css/mypage/myBoard.css" />
...
<body>
	...
	<div class="container">
		...
		<div class="contents">
			...
			<div id="searchWrap">
				<div id="categorybtns">
					<a href="/mypage/board" style="background-color: var(--light-sub, #FBC252);">자유게시판</a>
					<a href="/mypage/petplace">펫플레이스</a>
				</div>
				<div id="searchbox">
					<div id="searchinput">
			...
			<div id="boardlist">
				<table id="boardtable">
					...
					<tbody>
						...
						<c:forEach items="${response.list}" var="board">
							<tr class="list_tr">
								<td>${board.seq}</td>
								<td><a href="/getboard?seq=${board.seq}">${board.board_title}</a></td>
