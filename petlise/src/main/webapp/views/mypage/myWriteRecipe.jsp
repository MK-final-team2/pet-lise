...
<link rel="stylesheet" href="/css/mypage/myWriteRecipe.css" />
...
<body>
	...
	<div class="container">
		...
		<div class="contents">
			<div class="contents_Title">내가 쓴 레시피</div>
			...
			<div id="boardlist">
				<table id="boardtable">
					...
					<tbody>
						...
						<c:forEach items="${response.list}" var="myrecipe">
							<tr class="list_tr">
								<td>${myrecipe.pet_category}</td>
								<td>${myrecipe.main_category}</td>
								<td>${myrecipe.sub_category}</td>
								<td><a href="/recipedetail?recipe_id=${myrecipe.recipe_id}">${myrecipe.recipe_title}</a></td>
		...
		<div class="modal" id="delete_alert_modal">
			<div class="modal_contents">
				...
				레시피 삭제 시 복구가 불가하며<br>
				레시피 작성 포인트는 회수됩니다.<br>
				정말 레시피를 삭제하시겠습니까?
				</div>
				<div class="modal_btn">
	...
	<script src="/js/mypage/myWriteRecipe.js"></script>
